...
// Contact Us page
Route::get('/contact-us/', 'ContactUsController@show_contact_us_page')->name('contact_us');
Route::post('/contact-us', 'ContactUsController@store')->name('contact-us.store');

// About Us Page
Route::get('/about-us/', 'AboutUsController@show_about_us_page')->name('about_us');
//Route::get('/vadhu-var-melava/', 'VadhuMelavaController@show_vadhu_melava_page')->name('vadhu_melava');
Route::get('/faq/', 'FaqController@show_faq_page')->name('faq');
