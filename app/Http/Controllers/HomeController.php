...
class HomeController extends Controller
{
    ...
    {
        $first_name       = ($request->first_name != null) ? $request->first_name : null;
        ...
        return view('frontend.member.member_listing.index', compact('users', 'first_name', 'age_from', 'age_to', 'member_code', 'matital_status', 'religion_id', 'caste_id', 'sub_caste_id', 'mother_tongue', 'profession', 'country_id', 'state_id', 'city_id', 'min_height', 'max_height', 'member_type'));
    }
