     ...
     */
     public function update(Request $request, $id)
     {
         ...
         if($address_type == 'present'){
             ...
             $this->messages = [
                 'present_add.required'         => translate('Address is required'),
         ...
         elseif($address_type == 'permanent'){
             ...
             $this->messages = [
                 'permanent_add.required'         => translate('Address is required'),
         ...
         if($address_type == 'present'){
             $address->addres      = $request->present_add;
         ...
         elseif($address_type == 'permanent'){
             $address->addres      = $request->permanent_add;
             $address->village      = $request->permanent_village;
             $address->taluka       = $request->permanent_taluka;
