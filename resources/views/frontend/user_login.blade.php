...
<div class="col-lg-10 col-xl-8 col-xxl-10 mx-auto text-center">
 ...
 <p>Enter your email id to login</p>
 </div></div>
</div>
                ...
                <div class="card">
                    <div class="card-body">
                        <!--<div class="mb-5 text-center">
                            <h1 class="h3 text-primary mb-0">{{ translate('Login') }}</h1>
                        </div>-->
                        ...
                        <form class="" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                ...
                                @if (addon_activation('otp_system'))
                                    <input type="text" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email') }}" placeholder="{{ translate('Email Or Phone')}}" name="email" id="email" minlength="5"  maxlength="50"  required>
                                @else
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" id="password" placeholder="********" minlength="8" required>
                                @error('password')
