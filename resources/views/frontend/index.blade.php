    ...
    @if (get_setting('show_homepage_slider') == 'on' && get_setting('home_slider_images') != null)
        <section class="position-relative overflow-hidden min-vh-100 d-flex home-slider-area">
            ...
            <div class="absolute-full">
                <div class="aiz-carousel aiz-carousel-full h-100" data-items="1" data-arrows='true' data-fade='true' data-infinite='true' data-autoplay='true'>
            ...
            <div class="container position-relative d-flex flex-column">
                <div class="row pt-2 pb-2 my-auto align-items-center">
                    ...
                    @if (!Auth::check() && get_setting('show_homepage_slider_registration') == 'on')
                        <div class="offset-xxl-3 offset-xl-3 col-lg-4 col-xxl-4 homepage-form">
                            <div class="card">
                                <div class="card-body">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        placeholder="{{ translate('Enter full name') }}" oninput="this.value = this.value.replace(/[^a-zA-Z ]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" minlength="3" maxlength="32"required>
                                                    @error('first_name')
                                                        <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                                ...
                                                <div class="col-lg-6">-->
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="email"
                                                            ...
                                                            placeholder="{{ translate('Email Address') }}" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required>
                                                        @error('email')
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="password"
                                                        ...
                                                        name="password" placeholder="********" aria-label="********" minlength="8" 
                                                        required>
                ...
                @if (Auth::check() && Auth::user()->user_type == 'member')
                    <div class="p-4 bg-white rounded-top border-bottom mb-5"
...
<!-- How It Works Section -->
    @if (get_setting('show_how_it_works_section') == 'on' && get_setting('how_it_works_steps_titles') != null)
        <section class="py-8 bg-white">
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 col-xl-8 col-xxl-10 mx-auto">
                        <div class="text-center section-title mb-5">
                            <h2 class="fw-600 mb-3 text-dark">{{ get_setting('how_it_works_title') }}</h2>
                            <p class="fw-400 fs-16">{{ get_setting('how_it_works_sub_title') }}</p>
                        </div>
                    </div>
                </div>
   ...
   <!-- premium member Section -->
    @if (get_setting('show_premium_member_section') == 'on')
        <section class="py-9 pt-0 bg-white" >
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 col-xl-8 col-xxl-10 mx-auto">
                        <div class="text-center section-title mb-5">
                            <h2 class="fw-600 mb-3 text-dark">{{ get_setting('premium_member_section_title') }}</h2>
                            <p class="fw-400 fs-16">{{ get_setting('premium_member_section_sub_title') }}</p>
                        </div>
                    </div>
                </div>
                        ...
                        @foreach ($homepage_best_features as $key => $homepage_best_feature)
                            <div class="col-lg">
                                <div class="border rounded position-relative z-1 border-gray-600 overflow-hidden mt-4">
                                    <div class="absolute-full bg-dark z--1"></div>
    ...
    @if (get_setting('show_happy_story_section') == 'on')
        <section class="py-7 bg-dark text-white bg-cover bg-center text-white happy-story" id="dark-busy">
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 col-xl-8 col-xxl-6 mx-auto">
                        <div class="text-center section-title mb-5">
                            ...
                            <a href="{{ route('story_details', $happy_story->id) }}"
                                ...
                                <div class="absolute-bottom-left p-3">
                                    <div class="position-relative z-1 p-3">
                                        <div class="absolute-full z--1 bg-dark"></div>
                                        <div class="text-primary text-truncate">
                                            {{ $happy_story->user->first_name . ' & ' . $happy_story->partner_name }}</div>
                                        <h2 class="h5 mb-0 fs-14 fw-400 lh-1-5 text-truncate-3 text-color-gray">
                                            {{ $happy_story->title }}
                                        </h2>
                                    </div>
                                </div>
    ...
    @if (get_setting('show_home_banner1_section') == 'on' && get_setting('home_banner1_images') != null)
        <section class="py-7  text-white bg-cover bg-center text-dark" >
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 col-xl-8 col-xxl-6 mx-auto">
                        <div class="text-center section-title mb-5">
                            <h2 class="fw-600 mb-3 text-dark">Membership & Events</h2>
                            <p class="fw-400 fs-16"You can rest assured that your personal information will always be kept confidential.</p>
                        </div>
                    </div>
                </div>
                <div class="row gutters-10">
    ...
    @if (get_setting('show_homapege_package_section') == 'on')
        <section class="py-7 pt-0 bg-white">
            <div class="container">
                <div class="row">
                                        ...
                                        @if ($package->id != 1)
                                            @if (Auth::check())
                                                <a href="{{ route('package_payment_methods', encrypt($package->id)) }}"
                                                    type="submit"
                                                    class="btn btn-primary">{{ translate('Enroll This Package') }}</a>
                                            @else
                                                <button type="submit" onclick="loginModal()"
                                                    class="btn btn-primary">{{ translate('Enroll This Package') }}</button>
                                            @endif
                                        @else
                                            <a href="javascript:void(0);"
                                                class="btn btn-light"><del>{{ translate('Enroll This Package') }}</del></a>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            @foreach (json_decode(get_setting('homepage_reviews')) as $key => $review)
                                <div class="carousel-box">
                                    <div class="text-center px-lg-9">
                                        ...
                                        <div class="fs-18 fw-300">{{ $review }}</div>
    ...
    <!-- Get Started -->
        <section class="py-7 bg-white">
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 col-xl-8 col-xxl-6 mx-auto">
                        <div class="text-center section-title mb-2">
                            <h2 class="fw-600 mb-3 text-dark">Your Story is Waiting to happen!</h2>
                            <!--<p class="fw-400 fs-16">Title should be added </p>-->
                        </div>
                    </div>
                </div>
                <div class="row gutters-10">
                        <div class="col-xl col-md-6">
                            <div class="text-center mt-0">
                                <a class="btn btn-sm bg-primary-grad text-white fw-600 py-1 py-3 px-5"
