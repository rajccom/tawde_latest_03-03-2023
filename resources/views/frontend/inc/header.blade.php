...
<!--<div class="@if(get_setting('header_stikcy') == 'on') position-fixed @else position-absolute @endif w-100 top-0 z-1020">-->
            ...
            <div class="row align-items-center">
                <div class="col-lg-4 col">
                    <ul class="list-inline d-flex justify-content-between justify-content-lg-start mb-0">
                        <li class="list-inline-item">
                          <a href="{{ get_setting('header_left_quick_link1') }}" class="text-reset">
                ...
                <div class="col-lg-8 col">
                    <ul class="list-inline mb-0 d-flex align-items-center justify-content-end ">
                        <li class="list-inline-item mr-3 pr-3 border-right text-reset"><div id="google_translate_element"></div></li>
                        <li class="list-inline-item mr-3 pr-3 border-right text-reset">
                        ...
                        <li class="list-inline-item dropdown">
                            <a href="javascript:void(0)" class="dropdown-toggle text-reset no-arrow p-5px"
                                data-toggle="dropdown" data-display="static">
                                <i class="las la-envelope fs-16"></i>
                                    ...
                                    <a href="{{ route('all.messages') }}"
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body minw-0">
                                                ...
                                                <div class="fs-12 text-truncate">{{ $chat->message }}</div>
                                                @else
                                                <div class="fs-12 text-truncate">{{ translate('Attachments') }}
                                                </div>
                                                @endif
                                            </div>
                        ...
                        <li class="list-inline-item ml-4">
                            <a class="text-reset" href="{{ route('login') }}">{{ translate('Log In') }}</a>
                        </li>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto mb-0 pl-0 ml-lg-auto d-lg-flex align-items-stretch justify-content-center justify-content-lg-start mobile-hor-swipe">
      <li class="nav-item d-inline-block d-lg-flex pb-1 {{ areActiveRoutes(['home'],'bg-primary-grad') }}">
        <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center bg-white py-2" href="{{ route('home') }}">HOME <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item d-inline-block d-lg-flex pb-1 {{ areActiveRoutes(['about_us'],'bg-primary-grad') }}">
        <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center bg-white py-2" href="{{ route('about_us') }}">ABOUT US</a>
      </li>
      <li class="nav-item d-inline-block d-lg-flex pb-1 {{ areActiveRoutes([''],'bg-primary-grad') }}">
        <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center bg-white py-2" href="https://www.tawdeatithibhavan.com" target="_blank">ATITHI BHAVAN</a>
      </li>
      <li class="nav-item d-inline-block d-lg-flex pb-1 {{ areActiveRoutes(['custom-pages.show_custom_page'],'bg-primary-grad') }}">
        <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center bg-white py-2" href="http://101.53.138.131/~bluesystech/staging/index.php/vadhu-var-melava">VADHU VAR MELAVA</a>
      </li>
      <li class="nav-item d-inline-block d-lg-flex pb-1 {{ areActiveRoutes(['happy_stories'],'bg-primary-grad') }}">
        <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center bg-white py-2" href="{{ route('happy_stories') }}">HAPPY STORIES</a>
      </li>
      <li class="nav-item d-inline-block d-lg-flex pb-1 {{ areActiveRoutes(['contact_us'],'bg-primary-grad') }}">
        <a class="nav-link text-uppercase fw-700 fs-15 d-flex align-items-center bg-white py-2" href="{{ route('contact_us') }}">CONTACT US</a>
      </li>
                ...
                <ul class="list-inline d-flex align-items-center justify-content-end mb-0">
                    <li class="list-inline-item">
                        <a href="{{ route('dashboard') }}"
                            class="text-reset d-inline-block px-2 py-3 fw-600 {{ areActiveRoutes(['dashboard'],'text-primary-grad opacity-100') }}">
                    ...
                    <li class="list-inline-item">
                        <a href="{{ route('profile_settings') }}"
                            class="text-reset d-inline-block px-2 py-3 fw-600 {{ areActiveRoutes(['profile_settings'],'text-primary-grad opacity-100') }}">
                    ...
                    <li class="list-inline-item">
                        <a href="{{ route('member.listing') }}"
                            class="text-reset d-inline-block px-2 py-3 fw-600 {{ areActiveRoutes(['member.listing'],'text-primary-grad opacity-100') }}">
                    ...
                    <li class="list-inline-item">
                        <a href="{{ route('my_interests.index') }}"
                            class="text-reset d-inline-block px-2 py-3 fw-600 {{ areActiveRoutes(['express-interest.index'],'text-primary-grad opacity-100') }}">
                    ...
                    <li class="list-inline-item">
                        <a href="{{route('my_shortlists')}}"
                            class="text-reset d-inline-block px-2 py-3 fw-600 {{ areActiveRoutes(['my_shortlists'],'text-primary-grad opacity-100') }}">
                    ...
                    <li class="list-inline-item">
                        <a href="{{ route('all.messages') }}"
                            class="text-reset d-inline-block px-2 py-3 fw-600 {{ areActiveRoutes(['all.messages'],'text-primary-grad opacity-100') }}">
                    ...
                    <li class="list-inline-item">
                        <a href="{{ route('my_ignored_list') }}"
                            class="text-reset d-inline-block px-2 py-3 fw-600 {{ areActiveRoutes(['my_ignored_list'],'text-primary-grad opacity-100') }}">
