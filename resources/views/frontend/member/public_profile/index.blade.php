        ...
        <div class="container">
                ...
                <div class="col-xl-4 col-xxl-3 order-1 order-xl-0">
                    <div class="aiz-profile-sidebar">
                        ...
                        <div class="mb-4 p-4 border rounded border-gray-200 d-none d-xl-block">
                            ...
                            <h2 class="fs-20 fw-500">{{ $user->first_name }}</h2>
                                            ...
                                            <div class="col">
                                                <div class="p-3">
                                                    <h5 class="fs-16 text-body text-truncate">
                                                        {{ $similar_profile->user->first_name }}
                                                    </h5>
            ...
            <div class="col-xl-8 offset-xxl-1">
                ...
                <div class="mb-4 p-4 border rounded border-gray-200 d-xl-none">
                    ...
                    <h2 class="fs-20 fw-500 mb-4">{{ $user->first_name }}</h2>
                        ...
                        <div class="accordion aiz-timeline-accordion" id="profile-accordion">
                            ...
                            <div class="pb-4 accordion-item">
                                <div class="accordion-head c-pointer d-flex align-items-center mb-4" data-toggle="collapse"
                                    ...
                                    <div class="ml-4">
                                        <span
                                            class="fs-18 fw-600 d-block">{{ translate('About ') }}{{ $user->first_name }}</span>
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-sm-6">
                                                <table class="w-100">
                                                    <tbody>
                                                        <tr>
                                                            <td class="py-1 fw-600">{{ translate('Name') }}
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="py-1 fw-600">{{ translate('Language') }}
                                                            </td>
                                                            <td class="py-1">
                                                        ...
                                                        <tr>
                                                            <td class="py-1 fw-600">
                                                                {{ translate('AadharCard Number') }}
                                                            </td>
                                                            <td class="py-1">{{ $user->member->aadhar_card }}
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            <div class="col-sm-6 border-sm-left ">
                                                <table class="w-100 ml-sm-4">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="py-1 fw-600">
                                                                {{ translate('Pancard Number') }}
                                                            </td>
                                                            <td class="py-1">{{ $user->member->pancard }}
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <div class="border p-3">
                                                    <table class="w-100">
                                                        <tbody>
                                                            <tr>
                                                                <td class="py-1 fw-600">
                                                                    <i class="las text-primary mr-2 la-home"></i>
                                                                    <span>{{ translate('Address') }}</span>
                                                                </td>
                                                                <td class="py-1">
                                                                    {{ !empty($present_address->addres) ? $present_address->addres : '' }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="py-1 fw-600">
                                                ...
                                                <div class="col-sm-6 border-sm-left ">
                                                    <table class="w-100 ml-sm-4">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <th class="py-1">{{ translate('Spectcals') }}
                                                                </th>
                                                                <td class="py-1">
                                                                    {{ !empty($user->lifestyles->spectcals) ? $user->lifestyles->spectcals : '' }}
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <div class="row no-gutters">
                                                <div class="col-md-6">
                                                    <table class="w-100">
                                                        <tbody>
                                                            <tr>
                                                                <th class="py-1">{{ translate('Address') }}</th>
                                                                <td class="py-1">
                                                                    {{ !empty($permanent_address->addres) ? $permanent_address->addres : '' }}
                                                                </td>
                                                            </tr>
                                                             <tr>
                                                                <th class="py-1">{{ translate('Taluka') }}</th>
                                                                <td class="py-1">
                                                                    {{ !empty($permanent_address->taluka) ? $permanent_address->taluka : '' }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                ...
                                                <div class="col-sm-6 border-sm-left ">
                                                    <table class="w-100 ml-sm-4">
                                                        <tbody>
                                                            <tr>
                                                                <th class="py-1">{{ translate('Village') }}</th>
                                                                <td class="py-1">
                                                                    {{ !empty($permanent_address->village) ? $permanent_address->village : '' }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                ...
                                                <div class="col-md-6">
                                                    <table class="w-100">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <th class="py-1">{{ translate('Father Occupation') }}
                                                                </th>
                                                                <td class="py-1">
                                                                    {{ !empty($user->families->father_occupation) ? $user->families->father_occupation : '' }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th class="py-1">{{ translate('No of Brother') }}</th>
                                                                <td class="py-1">
                                                                    {{ !empty($user->families->brother) ? $user->families->brother : '' }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th class="py-1">{{ translate('Brother Married') }}
                                                                </th>
                                                                <td class="py-1">
                                                                    {{ !empty($user->families->brother_married) ? $user->families->brother_married : '' }}
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table class="w-100 ml-sm-4">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="py-1">
                                                                    {{ !empty($user->families->mother_occupation) ? $user->families->mother_occupation : '' }}
                                                                </td>
                                                            </tr>
                                                             <tr>
                                                                <th class="py-1">{{ translate('No of Sister') }}</th>
                                                                <td class="py-1">
                                                                    {{ !empty($user->families->sister) ? $user->families->sister : '' }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th class="py-1">{{ translate('Sister Married') }}
                                                                </th>
                                                                <td class="py-1">
                                                                    {{ !empty($user->families->sister_married) ? $user->families->sister_married : '' }}
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                            ...
                            <div class="">
                                <table class="table table-responsive">
                                    <tr>
                                        ...
                                        <td>
                                         @php
                                            $language =  !empty($user->partner_expectations->language_id) ? $user->partner_expectations->language_id : "";
                                            if(!empty($language)){
