    ...
    <div class="card-body">
        ...
        <form action="{{ route('member.basic_info_update', $member->id) }}" method="POST">
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    <label for="first_name" >{{translate('Name')}}
                        <span class="text-danger">*</span>
                    </label> 
                    <input type="text" name="first_name" value="{{ $member->first_name }}" class="form-control" placeholder="{{translate('Name')}}" required>
                    @error('first_name')
                ...
                <div class="col-md-6">
                    ...
                    <input type="tel" name="phone" value="{{ $member->phone }}" class="form-control @error('phone') is-invalid @enderror" placeholder="{{translate('Phone')}}" maxlength="10" >
                    @error('phone') 
            ...
            <div class="form-group row">
                <div class="col-md-6">
                    <label for="first_name" >{{translate('Pancard Number')}}
                        <span class="text-danger">*</span>
                    </label>
                    <input type="text" name="pancard" value="{{ $member->member->pancard }}" class="form-control uc-text" placeholder="{{translate('Pancard Number')}}"  minlength="10" maxlength="10" required >
                </div>
                <div class="col-md-6">
                    <label for="first_name" >{{translate('AadharCard Number')}}
                        <span class="text-danger">*</span>
                    </label>
                    <input type="tel" name="aadhar_card" value="{{ $member->member->aadhar_card }}" class="form-control" placeholder="{{translate('AadharCard Number')}}" minlength="12" maxlength="12" required >
                </div>
            </div>
            <div class="form-group row">
                <div class="col-md-12">
            ...
            <div class="form-group row">
                <div class="col-md-12">
                    ...
                    <small>Profile photo must be closed up or selfie</small>
                </div>
            </div>
