<form action="{{ route('education.store') }}" method="POST">
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="date" name="education_start"  placeholder="{{translate('Start Date')}}" class="form-control" >
               <!--<input type="number" name="education_start" class="form-control" placeholder="{{translate('Start Date')}}" required>-->
            </div>
        </div>
        <div class="form-group row">
            <label class="col-md-3 col-form-label">{{translate('End Date')}}</label>
            <div class="col-md-9">
                <input type="date" name="education_end"  placeholder="{{ translate('End Date') }}" class="form-control" >
            </div>
        </div>
    </div>
