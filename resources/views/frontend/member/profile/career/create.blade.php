<form action="{{ route('career.store') }}" method="POST">
    ...
    <div class="modal-body">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="date" name="career_start" class="form-control" placeholder="{{translate('Date')}}" required>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-md-9">
                 @php $career_emp = !empty($career->emp) ? $career->emp : ""; @endphp
                    <select class="form-control aiz-selectpicker" name="emp" required>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                 @php $career_income = !empty($career->income) ? $career->income : ""; @endphp
                    <select class="form-control aiz-selectpicker" name="income" required>
                        <option value="">{{translate('Select')}}</option>
                        ...
                        <option value="Lakh 1-3" @if($career_income ==  'Lakh 1-3') selected @endif >{{translate('Lakh 1-3')}}</option>
                        <option value="Lakh 4-6" @if($career_income ==  'Lakh 4-6') selected @endif >{{translate('Lakh 4-6')}}</option>
