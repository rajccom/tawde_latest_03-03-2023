...
<div class="card-body">
    <form action="{{ route('address.update', $member->id) }}" method="POST">
        ...
        <div class="form-group row">
            <div class="col-md-12">
                <label for="permanent_add">{{translate('Address')}}</label>
                <input type="text" name="permanent_add" value="{{ !empty($permanent_address->addres) ? $permanent_address->addres : "" }}" class="form-control" placeholder="{{translate('Address')}}" >
                @error('permanent_add')
            ...
            <div class="form-group row">
            <div class="col-md-6">
                <label for="permanent_village">{{translate('Village')}}</label>
                <input type="text" name="permanent_village" value="{{ !empty($permanent_address->village) ? $permanent_address->village : "" }}" class="form-control" placeholder="{{translate('Village')}}" >
                @error('permanent_village')
                    <small class="form-text text-danger">{{ $message }}</small>
                @enderror
            </div>
            <div class="col-md-6">
                <label for="permanent_taluka">{{translate('Taluka')}}</label>
                <input type="text" name="permanent_taluka" value="{{ !empty($permanent_address->taluka) ? $permanent_address->taluka : "" }}" class="form-control" placeholder="{{translate('Taluka')}}" >
