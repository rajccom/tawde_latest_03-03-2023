    ...
    <form action="{{ route('member.basic_info_update', $member->id) }}" method="POST">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="phone" value="{{ $member->phone }}" class="form-control @error('phone') is-invalid @enderror" placeholder="{{translate('Phone')}}">
               <!-- 03-01-23 -->
               @error('phone') 
        ...
        <div class="form-group row">
                <div class="col-md-6">
                    ...
                    <input type="text" name="pancard" value="{{ $member->member->pancard }}" class="form-control" placeholder="{{translate('Pancard Number')}}"  >
                </div>
                <div class="col-md-6">
                    <label for="first_name" >{{translate('AadharCard Number')}}
                        <span class="text-danger">*</span>
                    </label>
                    <input type="text" name="aadhar_card" value="{{ $member->member->aadhar_card }}" class="form-control" placeholder="{{translate('AadharCard Number')}}" >
                </div>
            </div>
        <div class="form-group row">
            <div class="col-md-12">
