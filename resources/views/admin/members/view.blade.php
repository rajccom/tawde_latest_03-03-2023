        ...
        <div class="card">
            <div class="card-body text-center">
                ...
                <div class="pad-ver btn-groups">
    				<a href="javascript:void(0);" onclick="package_info({{$member->id}})" class="btn btn-primary btn-sm add-tooltip">{{ translate('Package') }}</i></a>
                    @if($member->blocked == 0)
                        <a href="javascript:void(0);" onclick="block_member({{$member->id}})" class="btn btn-danger btn-sm add-tooltip">{{ translate('Block') }}</i></a>
                    @elseif($member->blocked == 1)
                        <a href="javascript:void(0);" onclick="unblock_member({{$member->id}})" class="btn btn-danger btn-sm add-tooltip">{{ translate('Unblock') }}</i></a>
                    @endif
                    <br><br>
    ...
    <div class="col-lg-9">
        ...
        <div class="card">
            ...
            <div class="card-body ">
                <table class="table">
                    <tr>
                    <th>{{translate('Form Number')}}</th>
                    <td>{{ $member->member->form_no }}</td>
                    </tr>
                    <tr>
                    <th>{{translate('Introduction')}}</th>
                    <td>{{ $member->member->introduction }}</td>    
                    </tr>
                </table>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <tr>
                    <th>{{translate('Pancard')}}</th>
                    <td>{{ $member->member->pancard }}</td>
                    
                    <th>{{translate('Aadhar Card')}}</th>
                    <td>{{ $member->member->aadhar_card }}</td>
                </tr>
                <tr>
                  ...
                  <table class="table">
                      @php $present_address = \App\Models\Address::where('user_id',$member->id)->where('type','present')->first(); @endphp
                			<tr>
                				...
                				<td>{{ !empty($present_address->addres) ? $present_address->addres : "" }}</td>
                			</tr>
                			<tr>
              ...
              <div class="card-body">
                  <table class="table">
                      <tr>
                          ...
                          <th>{{translate('Current Working')}}</th>
                      </tr>
              ...
              <div class="card-body">
                  <table class="table">
                      ...
                      <tr>
                          ...
                          <th>{{translate('Spectcals')}}</th>
                          <td>{{ !empty($member->lifestyles->spectcals) ? $member->lifestyles->spectcals : "" }}</td>
                      </tr>
                  </table>
              </div>
          </div>
          ...
          <div class="card">
              ...
              <div class="card-body">
                  <table class="table">
                      ...
                      <tr>
                			    <th>{{translate('Address')}}</th>
                				<td>{{ !empty($permanent_address->addres) ? $permanent_address->addres : "" }}</td>
                	  </tr>
                	  <tr>
                			    <th>{{translate('Village')}}</th>
                				<td>{{ !empty($permanent_address->village) ? $permanent_address->village : "" }}</td>
                				
                				 <th>{{translate('Taluka')}}</th>
                				<td>{{ !empty($permanent_address->taluka) ? $permanent_address->taluka : "" }}</td>
                	  </tr>
                      <tr>
                          <th>{{translate('City')}}</th>
              ...
              <div class="card-body">
                  <table class="table">
                      ...
                      <tr>
                          ...
                          <td>{{ !empty($member->families->father_occupation) ? $member->families->father_occupation : "" }}</td>
                          
                          <th>{{translate('Mother Occupation')}}</th>
                          <td>{{ !empty($member->families->mother_occupation) ? $member->families->mother_occupation : "" }}</td>
                      </tr>
                      <tr>
                          <th>{{translate('No of Brother')}}</th>
                          <td>{{ !empty($member->families->brother) ? $member->families->brother : "" }}</td>
                          
                          <th>{{translate('No of Sister')}}</th>
                          <td>{{ !empty($member->families->sister) ? $member->families->sister : "" }}</td>
                      </tr>
                      <tr>
                          <th>{{translate('Brother Married')}}</th>
                          <td>{{ !empty($member->families->brother_married) ? $member->families->brother_married : "" }}</td>
                          
                          <th>{{translate('Sister Married')}}</th>
                          <td>{{ !empty($member->families->sister_married) ? $member->families->sister_married : "" }}</td>
                      </tr>
                  </table>
              </div>
          </div>
              ...
              <div class="card-body">
                  <table class="table">
                      <tr>
                          ...
                          <td>
                              @php
                              $language =  !empty($member->partner_expectations->language_id) ? $member->partner_expectations->language_id : "";
                              if(!empty($language)){
                              echo \App\Models\MemberLanguage::where('id',$language)->first()->name;
                              }
                              @endphp</td>
                      </tr>
                      <tr>
...
<!-- Print PDF HTML Code -->
 <div class="print" id="printableArea" hidden>
     <div class="row">
    <div class="col-lg-3">
        <div class="card">
            <div class="card-body text-center">
                ...
                <div class="card-body">
                     <h5 class="mb-0 h6">{{translate('Member Code')}}</h5>
                     <p>{{ $member->code }}</p>
                </div>
                    @if($member->deactivated == 0)
                        <span class=" badge-success">{{translate('Active Account')}}</span>
                    @else
                        <span class=" badge-danger">{{translate('Deactivated Account')}}</span>
                    @endif
                <!--<div class="pad-ver btn-groups">
    				<a href="javascript:void(0);" onclick="package_info({{$member->id}})" class="btn btn-primary btn-sm add-tooltip">{{ translate('Package') }}</i></a>
                    @if($member->blocked == 0)
