                                    ...
                                    <div class="tab-pane fade show @if($email_template->id == 1) active @endif" id="v-pills-{{ $email_template->id }}" role="tabpanel" aria-labelledby="v-pills-tab-1">
                                        <form action="{{ route('email-templates.update') }}" method="POST">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-10">
                                                    <textarea name="body" class="form-control aiz-text-editor" data-buttons='[["font", ["bold", "underline", "italic"]],["para", ["ul", "ol"]],["view", ["undo","redo"]],["insert", ["link"]]]' placeholder="Type.." data-min-height="300" required>{{ $email_template->body }}</textarea>
