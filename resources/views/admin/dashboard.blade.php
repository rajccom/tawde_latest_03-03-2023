        ...
        <div class="h-100 row gutters-10">
            <div class="col-6 mb-3">
                <div class="bg-white h-100 px-3 py-4 rounded shadow-sm d-flex flex-column justify-content-center">
                    <span class="fs-16 mb-2">{{ translate('Total Earnings') }}</span>
                    <div class="h2">{{ single_price(\App\Models\PackagePayment::where('payment_status','Paid')->get()->sum('amount')) }}</div>
                </div>
            </div>
            <div class="col-6 mb-3">
                <div class="bg-white h-100 px-3 py-4 rounded shadow-sm d-flex flex-column justify-content-center">
                    <span class="fs-16 mb-2">{{ translate('Last Month Earnings') }}</span>
                      @php
            ...
            <div class="col-6 mb-3">
                <div class="bg-white h-100 px-3 py-4 rounded shadow-sm d-flex flex-column justify-content-center">
                    <span class="fs-16 mb-2">{{ translate('Last 6 Months Earnings') }}</span>
                      @php
            ...
            <div class="col-6 mb-3">
                <div class="bg-white h-100 px-3 py-4 rounded shadow-sm d-flex flex-column justify-content-center">
                    <span class="fs-16 mb-2">{{ translate('Last 12 Months Earnings') }}</span>
                      @php
